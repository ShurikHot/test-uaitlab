        ...
        <div class="page-warranty">
            ...
            <div class="filters custom-scrollbar">
                ...
                <div class="filters-main">
                    <form id="filter-form" action="{{route('ate.index')}}" method="get">
            ...
            @if($technicalConclusions->isNotEmpty())
            <div class="card-content card-table">
                <div class="table-wrapper">
                    <div class="table table-actions layout-fixed add-scroll">
                        <div class="thead">
                            <div class="tr">
                                <div class="th">№ документу
                                    <a href="{{route('ate.index', ['sort_field' => 'number_1c', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Дата документу
                                    <a href="{{route('ate.index', ['sort_field' => 'date', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Артикул
                                    <a href="{{route('ate.index', ['sort_field' => 'product_article', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Назва товару
                                    <a href="{{route('ate.index', ['sort_field' => 'product_name', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Тип звернення
                                    <a href="{{route('ate.index', ['sort_field' => 'appeal_type', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Поточний статус
                                    <a href="{{route('ate.index', ['sort_field' => 'status', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Автор документу
                                    <a href="{{route('ate.index', ['sort_field' => 'autor', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                                <div class="th">Менеджер
                                    <a href="{{route('ate.index', ['sort_field' => 'autor', 'sort_direction' => $sortDirection === 'asc' ? 'desc' : 'asc'])}}" class="icon-switch"></a>
                                </div>
                        ...
                        <div class="tbody">
                            @foreach($technicalConclusions as $technicalConclusion)
                                <div class="tr">
                                    <a href="{{ route('ate.edit', $technicalConclusion->id) }}" style="display: contents; text-decoration: none; color: inherit;">
                                        <div class="td">{{$technicalConclusion->number_1c}}</div>
                                        <div class="td">{{$technicalConclusion->date}}</div>
                                        <div class="td">{{$technicalConclusion->warrantyClaim->product_article}}</div>
                                        <div class="td">{{$technicalConclusion->warrantyClaim->product_name}}</div>
                                        <div class="td">{{$technicalConclusion->appeal_type}}</div>
                                        <div class="td">
                                            <button type="button" class="btn-label blue">{{$technicalConclusion->warrantyClaim->status}}</button>
                                        </div>
                                        <div class="td">{{$technicalConclusion->warrantyClaim->autor}}</div>
                                        <div class="td">{{$technicalConclusion->warrantyClaim->autor}}</div>
            ...
            <div class="pagination">
                ...
                <div class="pagination-select-wrapper">
                    ...
                    <p>з <strong>{{$technicalConclusions->lastPage()}}</strong></p>
                </div>
            </div>
            @else
                <div class="">АТЕ відсутні</div>
            @endif
        </div>
    </div>
