                    ...
                    <div class="card-content card-form">
                        ...
                        <div class="inputs-group one-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="number_1c" value="{{$warranty->number_1c}}" name="number_1c" readonly>
                            </div>
                            <div class="form-group">
                                <label for="date">Дата документу</label>
                                <input type="text" id="date" name="date" value="{{$warranty->date}}" readonly>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-content card-form">
                            ...
                            <div class="inputs-group one-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="client_name" name="client_name" value="{{ old('client_name', $warranty->client_name ?? '') }}" placeholder="Прізвище Ім'я По батькові">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-content card-form">
                            ...
                            <div class="inputs-group one-row">
                                <div class="form-group required" data-required data-valid="empty">
                                    ...
                                    <input type="text" id="sender_name" name="sender_name" value="{{ old('sender_name', $warranty->sender_name ?? '') }}">
                    ...
                    <div class="card-content card-form">
                        ...
                        <div class="inputs-group one-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="product_article" name="product_article" value="{{ old('product_article', $warranty->product_article ?? '') }}" placeholder="Артикул">
                            </div>
                            <div class="form-group">
                                <label for="product_name">Назва виробу</label>
                                <input type="text" id="product_name" name="product_name" value="{{ old('product_name', $warranty->product_name ?? '') }}" placeholder="Назва виробу">
                            </div>
                            <div class="form-group">
                                <label for="factory_number">Заводський номер</label>
                                <input type="text" id="factory_number" name="factory_number" value="{{ old('factory_number', $warranty->factory_number ?? '') }}" placeholder="">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="inputs-group one-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="point_of_sale" name="point_of_sale" value="{{ old('point_of_sale', $warranty->point_of_sale ?? '') }}" placeholder="Місце продажу">
                            </div>
                            <div class="form-group">
                                <label for="date_of_sale">Дата продажу</label>
                                <div class="input-wrapper">
                                    <input type="text" id="date_of_sale" name="date_of_sale" value="{{ old('date_of_sale', $warranty->date_of_sale ?? '') }}" placeholder="РРРР-ММ-ДД" class="_js-datepicker">
                            ...
                            <div class="form-group required" data-required data-valid="empty">
                                ...
                                <div class="input-wrapper">
                                    <input type="text" id="date_of_claim" name="date_of_claim" value="{{ old('date_of_claim', $warranty->date_of_claim ?? '') }}" placeholder="РРРР-ММ-ДД" class="_js-datepicker">
                                    <span class="icon-calendar"></span>
                                </div>
                                <div class="help-block" data-empty="Required field"></div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="receipt_number" name="receipt_number" value="{{ old('receipt_number', $warranty->receipt_number ?? '') }}" placeholder="0000000000">
                            </div>
                        </div>
                    </div>
                    <div class="card-content card-form">
                        ...
                        <div class="inputs-group one-row">
                            <div class="form-group required" data-required data-valid="empty">
                                ...
                                <textarea id="details" name="details" placeholder="Точний опис дефекту" rows="3">{{ old('details', $warranty->details ?? '') }}</textarea>
                                <div class="help-block" data-empty="Required field"></div>
                            </div>
                            <div class="form-group required" data-required data-valid="empty">
                                <label for="conclusion">Причина дефекту</label>
                                <textarea id="conclusion" name="conclusion" placeholder="Причина дефекту" rows="3">{{ optional($warranty->technicalConclusions)->conclusion }}</textarea>
                                <div class="help-block" data-empty="Required field"></div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="table-body">
                                            @foreach($warranty->serviceWorks as $work)
                                                <div class="row">
                                                    ...
                                                    <div class="cell">
                                                        <div class="form-group">
                                                            <input type="text" value="{{$work->sum}}" readonly="">
                                                        </div>
                                                    </div>
